...
export const LOGROS = {
  ...
  messages: [
    { title: '¡Primeras Palabras! 🗨️', desc: 'Envió 20 mensajes. ¡Ya rompiste el hielo!' },
  ...
  reactions: [
    ...
    { title: '¡Señor de las Reacciones! 🧙‍♂️', desc: 'Agregó 1,000 reacciones. ¡Tus reacciones son leyenda!' },
  ...
  voice: [
    ...
    { title: '¡Locutor Amateur! 🎙️', desc: 'Pasó 720 minutos en voz. ¡Tu voz es conocida!' },
